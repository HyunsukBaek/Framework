...
/* System Settings */
    ...
    // aosoul added
    minimum_cops_gas = 5; //Minimum cops required online to rob the gasstation
    minimum_cops_casino = 4; //카지노 이용 최소 경찰 접속 인원
    ...
    fuelCan_refuel = 8100; //Cost to refuel an empty fuel canister at the fuel station pumps. (Be wary of your buy/sell prices on fuel cans to prevent exploits...)
    ...
    animaltypes_hunting[] = { "Sheep_random_F", "Goat_random_F", "Hen_random_F", "Cock_random_F", "Rabbit_F", "Snake_random_F" }; //Classnames of aniamls you can hunt/gut
    ...
    sendtoJail_locations[] = { "police_hq_1", "police_hq_2", "cop_spawn_3", "cop_spawn_4", "cop_spawn_5", "police_jail" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
    ...
    paycheck_civ = 6000; //Payment for civillians
    ...
    crimes[] = {
        ...
        {"STR_Crime_3","40000","3"},//교통법위반
        {"STR_Crime_4","40000","4"},//기물파손
        ...
        {"STR_Crime_17","5000","17"}, //노상방뇨
        {"STR_Crime_18","20000","18"}, //공무집행 협조거부
        {"STR_Crime_19","60000","19"},//폭행 도주
        {"STR_Crime_20","25000","20"}, //시민모욕
        {"STR_Crime_21","30000","21"}, //경찰모욕
        {"STR_Crime_22","100000","22"}, //마약판매
        {"STR_Crime_23","350000","23"}, //연방은행절도
        {"STR_Crime_24","150000","24"}, //살인
        {"STR_Crime_25","150000","25"}, //살인
        {"STR_Crime_26","45000","26"}, //주유소강도
        {"STR_Crime_27","50000","27"}, //주유소강도미수
        {"STR_Crime_28","50000","28"}  //불법카지노
    };
};
