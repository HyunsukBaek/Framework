...
if(life_cash >= _cost) then
{
    ...
    _slots = ["textures\AOSoul\Slots\slotmachine\cherry.jpg","textures\AOSoul\Slots\slotmachine\leaf.jpg","textures\AOSoul\Slots\slotmachine\plum.jpg","textures\AOSoul\Slots\slotmachine\grapes.jpg","textures\AOSoul\Slots\slotmachine\glass.jpg","textures\AOSoul\Slots\slotmachine\bell.jpg","textures\AOSoul\Slots\slotmachine\seven.jpg","textures\AOSoul\Slots\slotmachine\bar.jpg"];
    ...
    //_rollA ctrlSetText ("textures\AOSoul\Slots\slotmachine\spinning.paa");
    //_rollB ctrlSetText ("textures\AOSoul\Slots\slotmachine\spinning.paa");
    //_rollC ctrlSetText ("textures\AOSoul\Slots\slotmachine\spinning.paa");
