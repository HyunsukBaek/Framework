...
if ((lbCurSel ((findDisplay 3500) displayCtrl 3503)) isEqualTo -1)exitWith {["Du musst zuerst etwas auswahlen.",true,"fast","orange","Error"]spawn Life_fnc_msg;};
...
if(_num < 1) exitWith {["Du hast kein Platz dafur.",true,"fast","orange","Error"]spawn Life_fnc_msg;};
