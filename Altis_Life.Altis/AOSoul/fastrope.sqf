if(!(player getVariable["restrained",TRUE])) exitWith {hintSilent "체포되어 불가능합니다"};

#define MAX_SPEED_WHILE_FASTROPING 15
#define MAX_SPEED_ROPES_AVAIL 50

#define STR_TOSS_ROPES "로프 던지기"
#define STR_FAST_ROPE "레펠링!! 번지!"
#define STR_CUT_ROPES "로프 자르기"
