...
if ((getPlayerUID player) in ["76561198080113617","76561198055045009","76561198027776492"]) then { //all admins
    if ((getPlayerUID player) in ["76561198080113617","76561198055045009","76561198027776492"]) then { //mods
        adminmenu = [
            ["",true],
            ["Tools Menu", [2], "#USER:ModToolsMenu", -5, [["expression", ""]], "1", "1"],
            ["Exit", [3], "", -3, [["expression", ""]], "1", "1"]
        ];};
    if ((getPlayerUID player) in ["76561198080113617","76561198055045009","76561198027776492"]) then { //admins
        adminmenu = [
            ["",true],
            ["Tools Menu", [2], "#USER:AdminToolsMenu", -5, [["expression", ""]], "1", "1"],
            ["Exit", [3], "", -3, [["expression", ""]], "1", "1"]
        ];};
    if ((getPlayerUID player) in ["76561198080113617","76561198055045009","76561198027776492"]) then { // super admins
        adminmenu = [
            ["",true],
